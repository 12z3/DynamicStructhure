...
public class eDSK extends eFinance {
    ...
    private static void findByDateN(List<String> list, String fromDate, String toDate) {
        ...
        // todo: Ако датата е в диапазона от валидни дати как ще търсиш следващата валидна дата. Единия метод търси във
        //       възходяща позиция на датите, другия в низходяща. Трябва да определиш кой от двата да се използва.
...
//            } else toDate = findNextValidDateTo(list, toDate);
    ...
    private static String findNextValidDateUp(List<String> list, String date) {
        ...
        while (searchingMatchesDates(list, date) == -1) {
            ...
            cnt++;
            if (cnt > list.size()) return "404: Не съществува друга валидна дата";
        }
        return date;
    }
