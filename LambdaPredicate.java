...
public class LambdaPredicate {
    ...
    Predicate -> Функция, която приема параметър(условие) и връща или true или false.
    "number -> number > 0". Ламбда функцията приема паръметъра "number" и връща "number > 0"
    "number -> number > 0" "number" -> (Отива в) "number > 0"
    Изявление, състояние на нещо си.
